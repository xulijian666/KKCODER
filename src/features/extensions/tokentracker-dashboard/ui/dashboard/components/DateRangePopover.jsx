    ...
    <div className="p-4">
      <DayPicker
        ...
        classNames={{
          ...
          button_previous: "inline-flex items-center justify-center w-7 h-7 rounded-md text-[var(--text-secondary)] hover:text-[var(--text-primary)] bg-[var(--bg-active-item)] border border-[var(--border-color)] hover:border-[var(--color-primary)] transition-all cursor-pointer",
          button_next: "inline-flex items-center justify-center w-7 h-7 rounded-md text-[var(--text-secondary)] hover:text-[var(--text-primary)] bg-[var(--bg-active-item)] border border-[var(--border-color)] hover:border-[var(--color-primary)] transition-all cursor-pointer",
          chevron: "w-3.5 h-3.5 fill-current",
          month_grid: "border-collapse",
          weekdays: "flex",
          weekday: "w-9 text-center text-xs font-semibold text-[var(--text-secondary)] py-1",
          week: "flex",
          day: "w-9 h-9 text-center text-sm p-0 relative",
          day_button: "w-full h-full inline-flex items-center justify-center rounded-md transition-all text-[var(--text-primary)] bg-transparent hover:bg-[var(--bg-hover-item)] cursor-pointer rdp-day-btn font-mono text-[12.5px]",

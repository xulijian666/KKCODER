...
// Shares the terminal-native inspection language
  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={cn(
          "relative w-full max-w-4xl max-h-[88vh] backdrop-blur-2xl bg-[var(--bg-main)] border border-[var(--border-color)] shadow-2xl rounded-2xl flex flex-col md:flex-row overflow-hidden",
      ...
      >
        <button
          ...
          className="absolute top-4 right-4 z-50 p-2 rounded-full border border-[var(--border-color)] bg-[var(--bg-active-item)] text-[var(--text-secondary)] hover:text-[var(--color-primary)] hover:border-[var(--color-primary)] hover:rotate-90 hover:scale-105 active:scale-95 transition-all duration-300 cursor-pointer"
        >
          <X size={16} />
        </button>

        {/* Left: identity + aggregate stats */}
        <div className="w-full md:w-[300px] shrink-0 border-b md:border-b-0 md:border-r border-[var(--border-color)] p-5 md:p-6 flex flex-col gap-5 overflow-y-auto backdrop-blur-md bg-[var(--bg-sidebar)]">

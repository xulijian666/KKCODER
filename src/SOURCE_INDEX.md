...
**最后人工维护核对：** 2026-07-23（会话域拆分 + Agent 启用筛选合并）
...
| `App.tsx` | 窗口壳、会话/标签/队列/预览编排，组装布局与弹窗 |
...
| `SessionTabBar.tsx` | 顶部标签栏 UI | `SessionTabBar` |
| `TabContextMenu.tsx` | 标签右键菜单 | `TabContextMenu` |
...
| `ProjectTree.tsx` | 右侧项目文件树 | `ProjectTree` |
| `SettingsModal.tsx` | 设置中心主弹窗 | `SettingsModal` |

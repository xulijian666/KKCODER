  ...
  return (
    <Card>
      ...
      <div className={`flex items-center justify-between gap-3 ${activeTab === "projects" ? "mb-4" : "mb-0"}`}>
        <div role="tablist" aria-label="Data view" className="flex rounded-lg border border-[var(--border-color)] bg-[var(--bg-active-item)] p-0.5 text-xs font-mono select-none">
          <button
            role="tab"
